...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775014131665-0iwucb | 2026-04-01T03:28:51.938Z

**Codebase Map:**
  scripts/: next-version
  apps/: electron.vite.config, postcss.config, gemini-dirty-data-cleanup.d, gemini-dirty-data-cleanup, gemini-dirty-data-dry-run.d, gemini-dirty-data-dry-run, app, storage-compat, capture-ipc
  packages/: capture-orchestrator, capture-event-repository, conversation-repository, message-repository, schema, signals, turn-persistence-service, turn-state, capture-event-repository.test
